function [ image_out ] = imageDownsample( image_in, factor )
    ...
    for kk=1:Nnew
        for mm=1:Nnew
            image_out(kk, mm) = mean(reshape(image_in((kk*factor-factor+1):kk*factor, (mm*factor-factor+1):mm*factor), 1, factor^2));
