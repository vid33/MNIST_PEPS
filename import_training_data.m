...
for kk=1:SAMPLE_NO
    ...
    training_images_cell{kk} = imageAddBlackBorder( training_images_cell{kk}, border_width );
    training_images_cell{kk} = imageDownsample(training_images_cell{kk}, downsample_factor);
end
