            ...
            for image_current=1:SAMPLE_NO
                W_Phi_envMPS_right{image_current, pos_horiz} = ...
                    PEPS_EnvironmentOfBipartition( W_Phi_PEPS{image_current}, ...
                        W_Phi_envMPS_right{image_current, pos_horiz+1}, pos_horiz+1, pos_horiz, 'right' );
        ...
        for pos_vert=N:-1:1
            ...
            for kk=1:SAMPLE_NO            
                ...
                elseif pos_horiz == N
                    ...
                    W_Phi_overlap(kk) =  MPS_Overlap(W_Phi_envMPS_left{kk, pos_horiz-1}, W_Phi_envMPS_right{kk, pos_horiz}, 'left', 'right');
                    Cfn_component(kk) = (W_Phi_overlap(kk) - isequal(TARGET, training_labels(kk))) ;
            ...
            % recalculate PEPS envoronmens, and renormalise - THIS IS NOT 100% OPTIMAL, BUT
            ...
            elseif pos_horiz == N
                ...
                for kk=1:SAMPLE_NO
                    W_Phi_envMPS_right{kk,pos_horiz} = ...
                        PEPS_EnvironmentOfBipartition( W_Phi_PEPS{kk}, ...
                            W_Phi_envMPS_right{kk, pos_horiz+1}, pos_horiz+1, pos_horiz, 'right' );
                end
            end  
        end
